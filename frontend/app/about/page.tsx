...
export const metadata: Metadata = {
  title: "Our Story",
  description: "The story behind Navcci Perfume — an atelier of niche perfumery in Mumbai.",
...
const TIMELINE = [
  ...
  { year: "2017", title: "Atelier founded", body: "Navcci Perfume opens its first 200 sq ft studio in Kala Ghoda." },
  ...
  { year: "2025", title: "Navcci 2.0", body: "A new flagship online — discovery sets, member benefits and same-day Mumbai delivery." },
];
  ...
  return (
    <>
      <section className="relative bg-ink-900 py-24 text-background">
        <div className="navcci-container max-w-3xl text-center">
          <p className="navcci-eyebrow text-gold-500">Our Story</p>
          <h1 className="mt-3 navcci-heading text-5xl md:text-6xl">A quiet love letter to fine fragrance.</h1>
          <p className="mt-6 text-lg leading-relaxed text-background/80">
            Navcci Perfume is an Indian atelier dedicated to niche perfumery. We curate
      ...
      <section className="navcci-container grid gap-12 py-20 md:grid-cols-2 md:items-center">
        ...
        <div>
          <p className="navcci-eyebrow text-gold-600">Mission</p>
          <h2 className="mt-2 navcci-heading text-3xl">Make fine fragrance personal again.</h2>
          ...
          <p className="mt-4 leading-relaxed text-muted-foreground">
            Navcci Perfume exists to bring independent perfumery back into the hands of
      ...
      <section className="bg-ink-50 dark:bg-ink-900 py-20">
        <div className="navcci-container">
          <h2 className="navcci-heading text-3xl text-center">Our Values</h2>
      ...
      <section className="navcci-container py-20">
        <h2 className="navcci-heading text-3xl text-center">Our Journey</h2>
        <ol className="mx-auto mt-12 max-w-3xl space-y-8 border-l border-border pl-6">
          {TIMELINE.map((step) => (
            <li key={step.year}>
              <p className="navcci-eyebrow text-gold-600">{step.year}</p>
