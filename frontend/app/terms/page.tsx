...
export default function TermsPage() {
  return (
    <Policy>
      ...
      <p>By using navcciperfume.in you agree to the following terms.</p>
      ...
      <p>All content on this site, including text, images and trademarks, is owned by Navcci Perfume or our licensors.</p>
      <h2>Limitation of liability</h2>
      <p>To the maximum extent permitted by law, Navcci Perfume is not liable for any indirect, incidental or consequential damages.</p>
      <h2>Governing law</h2>
